...
class Contrato(models.Model):
    ...
    responsavel_contratante = models.CharField(max_length=255, null=True, blank=True)
    responsavel_contratado = models.CharField(max_length=255, null=True, blank=True)
