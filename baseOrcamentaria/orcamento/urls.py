...
from . import views
from .views import RaizAnaliticaViewSet,CentroCustoPaiViewSet,CentroCustoViewSet,RaizSinteticaViewSet,GrupoItensViewSet,ContaContabilViewSet,OrcamentoBaseViewSet,AplicarPorcentagem
...
urlpatterns = [
    ...
    path('aplicarDissidio/', AplicarPorcentagem, name='choises')
]