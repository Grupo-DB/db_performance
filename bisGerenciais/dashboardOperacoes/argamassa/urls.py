...
from . import views
from .views import calculos_argamassa,calculos_argamassa_produtos,calculos_argamassa_graficos,calculos_argamassa_graficos_carregamento,calculos_argamassa_equipamentos,calculos_argamassa_produto_individual,calculos_argamassa_produtos_carregamento,calculos_indicadores_realizado
...
urlpatterns = [
    ...
    path('calcular_argamassa_produtos_carregamento/', calculos_argamassa_produtos_carregamento, name='argamassaProdutosCarregamento'),
