...
from . import views
from .views import calculos_cal,calculos_cal_produtos,calculos_cal_equipamentos,calculos_cal_graficos,calculos_equipamentos_detalhes,calculos_cal_graficos_carregamento
