...
from .views import AnaliseViewSet, AnaliseCalculoViewSet, AnaliseEnsaioViewSet,ChatViewSet,PublicAnaliseViewSet
...
router.register(r'public/analise', PublicAnaliseViewSet, basename='public-analise')
