...
from .views import TipoAmostraViewSet, ProdutoViewSet, AmostraViewSet, AmostraImagemViewSet, GarantiaProdutoViewSet
...
router.register(r'garantiaProduto', GarantiaProdutoViewSet, basename='GarantiaProduto')
urlpatterns = [
