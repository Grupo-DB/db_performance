...
class PlanoAnalise(models.Model):
    ...
    ensaios = models.ManyToManyField(Ensaio, blank=True, null=True, on_delete=models.RESTRICT, related_name='plano_ensaio')
    calculos_ensaio = models.ManyToManyField(CalculoEnsaio, blank=True,  null=True, on_delete=models.RESTRICT, related_name='plano_ensaio')
